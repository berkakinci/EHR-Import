...
Unlike pull_data.py which does broad searches, this script queries each subresource
...
from config import RAW_PULLS_DIR, PROVIDERS
...
def run_probes(provider_name: str, tokens: dict):
    ...
    outfile = RAW_PULLS_DIR / f"probe_{provider_name}_{patient_id[:8]}_{timestamp}.json"
